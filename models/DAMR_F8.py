...
from models import VTCNN2_1D
from models import DAMR_V
import torchmetrics
...
class DAMR_F8(ModelBase):
    ...
    def __init__(self,
        ...
        map_location='cuda:3'
        #Voting_model=DAMR_V.load_from_checkpoint(checkpoint_path,map_location=map_location)
        Voting_model=DAMR_V.load_from_checkpoint("/home/distributed_learning/logs/Voting-SimpleHDF5DataModule/version_0/checkpoints/epoch=2-step=37800.ckpt",map_location=map_location)
